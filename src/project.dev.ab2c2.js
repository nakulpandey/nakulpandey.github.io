window.__require = function e(t, n, r) {
  ...
  ButtonClickHandler: [ function(require, module, exports) {
    ...
    var ButtonClickHandler = function(_super) {
      ...
      ButtonClickHandler.prototype.handleClick = function() {
        this.node.runAction(cc.sequence([ cc.scaleTo(this.totalAnimationTime / 2, this.scaleTo, this.scaleTo), cc.scaleTo(this.totalAnimationTime / 2, 1, 1), cc.callFunc(this.bubbleEvent, this) ]));
      };
  ...
  GameController: [ function(require, module, exports) {
    ...
    var GameController = function(_super) {
      ...
      function GameController() {
        ...
        _this.kejaru = null;
        _this.netas = [];
        _this.waveOneNetas = 1;
        _this.waveTwoNetas = 10;
        _this.waveFinalNetas = 20;
        _this.canPlace = [ 0, 1, 2, 3, 4 ];
        _this.waveNumber = 1;
        _this.callout = null;
        return _this;
      }
      GameController.prototype.plantSelected = function(evt) {};
      GameController.prototype.handleNetaJiDead = function(evt) {
        var foundIndex = -1;
        this.netas.forEach(function(neta, index) {
          neta.uuid == evt.uuid && (foundIndex = index);
        });
        -1 != foundIndex && this.netas.splice(foundIndex, 1);
        0 == this.netas.length && this.sendNextNetaJi();
      };
      GameController.prototype.sendNextNetaJi = function() {
        if (0 == this.canPlace.length) {
          this.canPlace = [ 0, 1, 2, 3, 4 ];
          this.waveNumber += 1;
        }
        var randomRow = Math.floor(this.canPlace.length * Math.random());
        var position = null;
        position = 0 != randomRow ? this.gardenPlacement.getTileFromIndex(9 * randomRow - 1).getBottomMostMitPoint() : this.gardenPlacement.getTileFromIndex(8).getBottomMostMitPoint();
        this.canPlace.splice(randomRow, 1);
        this.callout.getComponent(cc.Label).string = "";
        var netaji = cc.instantiate(this.kejaru);
        var movementController = netaji.getComponent("KejaruSideController");
        movementController.walkingSpeed += movementController.walkingSpeed * (2 * Math.random());
        var netaJi = netaji.getComponent(NetaJi_1.default);
        netaJi.row = this.gardenPlacement.getTileFromIndex(9 * randomRow - 1).row;
        netaJi.column = 9;
        this.netas.push(netaji);
        var alreadyPlaced = 0;
        cc.director.getScene().addChild(netaji);
        netaji.setPosition(position);
      };
      GameController.prototype.startNetaJiWaves = function() {};
      GameController.prototype.handleNetaJiWins = function(evt) {
        this.callout.getComponent(cc.Label).string = "YOU LOOSE Neta Ji wins";
      };
      GameController.prototype.start = function() {
        cc.find("/Canvas").on("plant-slected", this.plantSelected, this);
        cc.find("/Canvas").on("netaJiDied", this.handleNetaJiDead, this);
        cc.find("/Canvas").on("NetaJiWins", this.handleNetaJiWins, this);
        this.gardenPlacement = cc.find("/Canvas/bg/gardenMesh").getComponent("GardenPlacement");
        this.callout = cc.find("/Canvas/HUD/GameCallout");
        var totalNetajis = this.waveOneNetas + this.waveTwoNetas + this.waveFinalNetas;
        this.callout.getComponent(cc.Label).string = "Collect Suns \n  and plant trees to \n defend your garden";
        this.node.runAction(cc.sequence([ cc.delayTime(5), cc.callFunc(this.sendNextNetaJi, this) ]));
      };
      __decorate([ property(cc.Prefab) ], GameController.prototype, "kejaru", void 0);
      __decorate([ property ], GameController.prototype, "waveOneNetas", void 0);
      __decorate([ property ], GameController.prototype, "waveTwoNetas", void 0);
      __decorate([ property ], GameController.prototype, "waveFinalNetas", void 0);
    ...
    var GardenPlacement = function(_super) {
      ...
      GardenPlacement.prototype.handleTileClicked = function(evt) {
        ...
        if (null != this.selectedPlant && !this.plantPresentAtIndex(index)) {
          ...
          cc.director.getScene().addChild(plant);
          ...
          plant.setPosition(evt.lowerCenter);
  ...
  PlayAndResumeButton: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "14a26gQ/tdMKo7+emnXWtb8", "PlayAndResumeButton");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var ButtonClickHandler_1 = require("../ButtonClickHandler");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var PlayAndResumeButtonHandler = function(_super) {
      __extends(PlayAndResumeButtonHandler, _super);
      function PlayAndResumeButtonHandler() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.isPauseButton = false;
        _this.popupPrefab = null;
        _this.insidePopUp = false;
        _this.rootNode = null;
        return _this;
      }
      PlayAndResumeButtonHandler.prototype.onload = function() {
        _super.prototype.onLoad.call(this);
      };
      PlayAndResumeButtonHandler.prototype.loadScene = function() {
        this.insidePopUp && (this.rootNode.active = false);
        if (this.isPauseButton) {
          cc.director.pause();
          if (!this.insidePopUp) {
            var popUp = cc.instantiate(this.popupPrefab);
            cc.director.getScene().addChild(popUp);
            popUp.getChildByName("layerBg").width = cc.winSize.width;
            popUp.getChildByName("layerBg").height = cc.winSize.height;
            popUp.setPosition(new cc.Vec2(cc.winSize.width / 2, cc.winSize.height / 2));
            cc.director.resume();
          }
        } else cc.director.resume();
      };
      __decorate([ property ], PlayAndResumeButtonHandler.prototype, "isPauseButton", void 0);
      __decorate([ property(cc.Prefab) ], PlayAndResumeButtonHandler.prototype, "popupPrefab", void 0);
      __decorate([ property ], PlayAndResumeButtonHandler.prototype, "insidePopUp", void 0);
      __decorate([ property(cc.Node) ], PlayAndResumeButtonHandler.prototype, "rootNode", void 0);
      PlayAndResumeButtonHandler = __decorate([ ccclass ], PlayAndResumeButtonHandler);
      return PlayAndResumeButtonHandler;
    }(ButtonClickHandler_1.default);
    exports.default = PlayAndResumeButtonHandler;
    cc._RF.pop();
  }, {
    "../ButtonClickHandler": "ButtonClickHandler"
  } ],
  ...
  SelectPlantController: [ function(require, module, exports) {
    ...
    var SelectPlantController = function(_super) {
      ...
      SelectPlantController.prototype.start = function() {
        ...
        this.sunRepository = cc.find("/Canvas/HUD/SunIndicator");
        ...
        this.veil.height = 0;
        this.gameCallout = cc.find("/Canvas/HUD/GameCallout");
      };
      ...
      SelectPlantController.prototype.handleClick = function(evt) {
        ...
        if (!this.canSelect()) {
          this.node.runAction(cc.sequence([ cc.scaleTo(.2, 1.1), cc.scaleTo(.2, 1) ]));
          return;
        }
        this.selected = true;
        cc.find("/Canvas").emit("slected-plant", {
  ...
  StarTapHandler: [ function(require, module, exports) {
    ...
    var StarTapHandler = function(_super) {
      ...
      StarTapHandler.prototype.update = function(dt) {
        ...
        this.liveTime += dt;
        this.liveTime > this.timeToLive && this.node.destroy();
      };
  ...
  StarsGenerator: [ function(require, module, exports) {
    ...
    var StarsGenerator = function(_super) {
      ...
      StarsGenerator.prototype.start = function() {};
      StarsGenerator.prototype.update = function(dt) {
        this.currentTime += dt;
        this.currentTime >= this.targetTime && this.launchStar();
      };
  ...
  SunFlowerController: [ function(require, module, exports) {
    ...
    var SunFlowerController = function(_super) {
      ...
      SunFlowerController.prototype.update = function(dt) {
        this.currentTime += dt;
        if (this.currentTime > this.productionRate) {
          this.currentTime = 0;
...
}, {}, [ "IntroductionScript", "EggGenerator", "StarSelector", "AnimationController", "StateMachine", "BirdMovement", "CollisionResolver", "GameController", "GardenPlacement", "NetaJi", "Plant", "PlantsRepository", "SelectPlantController", "StarRepositoryController", "StarTapHandler", "StarsGenerator", "ButtonClickHandler", "Globals", "LevelLoader", "LevelProgress", "LevelSelectorButton", "YouWinPopUp", "PlayAndResumeButton", "mainCamera", "netaJiProgressIndicator", "DebuggableNode", "GameProgress", "Level", "World", "ProgressLoader", "TileClickHandler", "HealthController", "AnimationHandler", "Brain", "KejaruController", "MovementController", "SpeechHandler", "States", "movement", "SpeechBoubleMovement", "SpeechSupplier", "Animations", "GameLayOutHandler", "peaShooter", "SunFlowerController", "KitanuController", "WaveController", "EggAnimationController", "EggMan", "Enums", "KejaruSideController", "LawnMover", "WifiController" ]);
